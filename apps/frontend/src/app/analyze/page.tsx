        ...
        for (const line of lines) {
          if (line.startsWith('data: ')) {
            ...
            try {
              ...
              if (data.progress === -1) {
                // Backend sent an error — show it to the user
                throw new Error(data.status || "AI processing failed");
              }
